...
public enum StatusUtil {
	...
	MVS_SUCCESS(StatusConstants.MVS_STAGE_SUCCESS + "001", "Manual verification from MVS success"),
	MVS_FAILED(StatusConstants.MVS_STAGE_FAILED + "002", "Manual verification from MVS failed"),
	...
	CITIZENSHIP_VERIFICATION_CLAN_MISMATCH(StatusConstants.CITIZENSHIP_VERIFICATION + "011",
			"CVS failed due to Mismatch in Clan with "),
	CITIZENSHIP_VERIFICATION_TRIBE_MISMATCH(StatusConstants.CITIZENSHIP_VERIFICATION + "012",
			"CVS failed due to Mismatch in Tribe with "),
	CITIZENSHIP_VERIFICATION_NO_PARENT_NIN(StatusConstants.CITIZENSHIP_VERIFICATION + "016",
			"CVS failed due to No parent has NIN"),
	CITIZENSHIP_VERIFICATION_GUARDIAN_NIN_MISSING(StatusConstants.CITIZENSHIP_VERIFICATION + "017",
			"CVS failed due to GUARDIAN_NIN is missing"),
	CITIZENSHIP_VERIFICATION_NOT_CITIZEN_BYBIRTH(StatusConstants.CITIZENSHIP_VERIFICATION + "018",
			"CVS failed due to applicant Not Citizen By Birth"),
