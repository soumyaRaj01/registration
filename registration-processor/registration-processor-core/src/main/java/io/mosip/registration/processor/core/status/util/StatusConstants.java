...
public final class StatusConstants {
	...
	public static final String CITIZENSHIP_VERIFICATION_NIN_USAGE_EXCEEDED = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_STATUS_CHECK_FAILED = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_AGE_DIFFERENCE_FAILED = CITIZENSHIP_VERIFICATION +  FAILED;
	public static final String CITIZENSHIP_VERIFICATION_PARENT_INFO_PROCESSING_ERROR = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_UIN_NOT_FOUND = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_PLACE_OF_ORIGIN_MISMATCH = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_CLAN_MISMATCH = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_TRIBE_MISMATCH = CITIZENSHIP_VERIFICATION + FAILED; 
	public static final String CITIZENSHIP_VERIFICATION_GUARDIAN_VALIDATION_FAILED = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_GUARDIAN_INFO_PROCESSING_ERROR = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_INSUFFICIENT_FATHER_INFO = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_NO_PARENT_NIN  = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_GUARDIAN_NIN_MISSING = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_NOT_CITIZEN_BYBIRTH = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_NOTIFICATION_FAILURE = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_DECEASED_STATUS_ERROR = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_UNEXPECTED_LIVING_STATUS = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_STATUS_INVALID = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_ALIVE_UIN_DEACTIVATED = CITIZENSHIP_VERIFICATION + FAILED;
	public static final String CITIZENSHIP_VERIFICATION_UNEXPECTED_UIN_STATUS = CITIZENSHIP_VERIFICATION + FAILED;
