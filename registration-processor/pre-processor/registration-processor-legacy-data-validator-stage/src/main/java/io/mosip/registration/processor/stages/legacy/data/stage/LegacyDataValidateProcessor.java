...
public class LegacyDataValidateProcessor {
	 ...
	 * The reg proc logger.
	 */
	private static Logger regProcLogger = RegProcessorLogger.getLogger(LegacyDataValidateProcessor.class);
	...
	@Autowired
	private LegacyDataValidator legacyDataValidator;
	...
	public MessageDTO process(MessageDTO object, String stageName) {
		...
		registrationStatusDto
				.setLatestTransactionTypeCode(RegistrationTransactionTypeCode.LEGACY_DATA_VALIDATE.toString());
