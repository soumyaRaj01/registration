package io.mosip.registration.processor.mvs.exception.handler;
...
import io.mosip.registration.processor.mvs.exception.FileNotFoundInFileStoreException;
import io.mosip.registration.processor.mvs.exception.FileNotPresentException;
import io.mosip.registration.processor.mvs.exception.InvalidFieldsException;
import io.mosip.registration.processor.mvs.exception.InvalidFileNameException;
import io.mosip.registration.processor.mvs.exception.InvalidTokenHandlerException;
import io.mosip.registration.processor.mvs.exception.InvalidUpdateException;
import io.mosip.registration.processor.mvs.exception.ManualVerificationAppException;
import io.mosip.registration.processor.mvs.exception.MatchTypeNotFoundException;
import io.mosip.registration.processor.mvs.exception.NoRecordAssignedException;
import io.mosip.registration.processor.mvs.exception.PacketNotFoundException;
import io.mosip.registration.processor.mvs.exception.UserIDNotPresentException;
import io.mosip.registration.processor.mvs.response.dto.ManualVerificationAssignResponseDTO;
import io.mosip.registration.processor.mvs.response.dto.ManualVerificationBioDemoResponseDTO;
 ...
 */
public class MVSExceptionHandler {

	/** The reg proc logger. */
	private static Logger regProcLogger = RegProcessorLogger.getLogger(MVSExceptionHandler.class);
	 ...
	 *            the id
	 */
	public MVSExceptionHandler(String id) {
		this.id = id;
	}
