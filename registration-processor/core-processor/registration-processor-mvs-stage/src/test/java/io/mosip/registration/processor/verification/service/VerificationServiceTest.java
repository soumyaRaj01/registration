...
public class VerificationServiceTest {
	...
	@InjectMocks
	private MVSService verificationService = new MVSServiceImpl();
	...
	@Mock
	private MVSStage manualAdjudicationStage;

	@Mock
	MVSService mockManualAdjudicationService;
	...
	public void setup() throws Exception {
		...
		regprocLogger = (Logger) LoggerFactory.getLogger(MVSServiceImpl.class);
